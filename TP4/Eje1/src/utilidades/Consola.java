...
public class Consola {
    ...
    */
    ...
    public static void imprimirMenu(String[] opciones, String titulo) {
        ...
        System.out.printf("| %-" + maxLongitud + "s |%n", titulo);
        System.out.println(lineaSeparacion);
        for (String opcion : opciones) {
    ...
    /**
     * Formatea una cadena de texto capitalizando su primera letra.
     * 
     * @param nombre la cadena de texto que se desea formatear.
     * @return una nueva cadena de texto con la primera letra en mayúscula.
     */
    public static String obtenerNombreFormateado(String nombre){
    ...
    /**
     * Formatea un nombre poniendo en mayúscula.
     * En caso de haber mas de un nombre 
     * se pone en mayuscula a todo String que este precedido de un espacio.
     * 
     * @param nombre El texto o nombre completo a formatear.
     * @return El nombre formateado con formato de tipo título (ej: "Juan Carlos").
     */
    public static String obtenerVariosNombresFormateado(String nombre) {
        String[] palabras = nombre.trim().split("\\s+"); // Se almacena cada caracter en un array
        StringBuilder str = new StringBuilder();
        for (int i = 0; i < palabras.length; i++) {
            String palabra = palabras[i];
            str.append(palabra.substring(0, 1).toUpperCase());
            str.append(palabra.substring(1).toLowerCase());
    ...
    *
    * @param msg el mensaje que se mostrará al usuario por consola antes de leer su respuesta.
